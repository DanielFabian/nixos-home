{
  ...
  outputs =
    ...
    in
    {
      ...
      # No KVM required — built natively from nixpkgs' installation-cd-base.
      # Workflow:
      ...
      # aarch64 ISO. Builds on any aarch64 host with /nix — including the
      # M5 Mac itself once it arrives.
